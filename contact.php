...
<html lang="en">
  ...
  <?php include 'partials/_nav.php';?>
      ...
      <div class="contact2" style="background-color: #fff" id="contact">
        <div class="container">
              ...
              <div class="card card-shadow border-0 mb-4">
                <div class="row">
                  ...
                  <?php
                    ...
                    echo '<div class="col-lg-4 bg-image" style="background-color: blue">
                          <div class="detail-box p-4">
                            <h5 class="text-white font-weight-light mb-3 mt-4">CALL US</h5>
                            <p class="text-white op-7"> 0769840399
                              <br>  0769840399 </p>
                          </div>
                        </div>';
                  ?>
