...
<body>
    ...
    <?php 
        ...
        <div class="alert alert-info my-3">
            <font style="font-size:22px"><center>Verifică comanda ta. Ai nevoie să te <strong><a class="alert-link" data-toggle="modal" data-target="#loginModal">Înregistrezi</a></strong></center></font>
        </div></div>';
    }
    ?>
